...
if rxFlag
    ...
    rfImpairmentSet = channel.rfImpairment; %add 22/11 OVV

    innerTransceiverSet.setThermalNoise( thermalNoiseSet ); 
    innerTransceiverSet.setrfImpairment( rfImpairmentSet ); % aa 22/11 OVV
else
    rxSamplerSet = [];
    thermalNoiseSet = [];
    rfImpairmentSet = [];
...
this.rfImpairment = rfImpairmentSet; % added 22/11 OVV
