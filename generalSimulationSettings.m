%GENERALSIMULATIONSETTINGS defines general simulation parameters
%
%   Syntax: generalSimulationSettings.m
%
%   Authors: Lilian Freitas (LCF), Erika Almeida (EA), Andr? Noll Barreto (ANB)
%   Work Address: INDT Manaus/Bras?lia
...
SETTINGS.DROPS.MAX_NUMBER_OF_DROPS = 10;

% Minimum number of drops - positive integer
SETTINGS.DROPS.MIN_NUMBER_OF_DROPS = 4;
...
SETTINGS.SNR.VECTOR_dB = 0:1:15;


% display options
SETTINGS.SHOW_PROGRESS = true; % display simulation progress
SETTINGS.DISPLAY_INTERVAL = 0.001; % display at a given simulation interval
...
SETTINGS.SCENARIO.MODEM{2}.EQUALIZATION = enum.modem.Equalization.MMSE;
% A list of permitted values may be found at:
...
SETTINGS.CHANNEL.RFIMPAIRMENT_TYPE = enum.channel.Rfimpairment.NONE; 

% A list of permitted values may be found at:
% src\+enum\+channel\RfImpairments.m
